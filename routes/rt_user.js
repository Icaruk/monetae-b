...
const { registerUser, loginUser, logoutUser, getAllUsers, getUser, deleteUser, userPassReset }  = require("../DB/db_user");
...
router.post("/user/forgotPassword", hasValidToken, userPassReset);
